    ...
    return (
        <>
            <aside className="sidebar">
                <div className="logo">
                    <a>Brand<b>ColorsPicker</b></a>
                </div>
                <div className="description">
                    The biggest collection of official brand color codes around. Curated by @brandcolorspicker and friends.
                </div>
                <nav className="menu">
                    <ul>
                        <li>
                            <a onClick={toggleModal}>About BrandColorsPicker</a>
                        </li>
                    </ul>
                </nav>
            </aside>
